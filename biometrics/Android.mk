...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.biometrics.fingerprint@2.0-service.xiaomi_santoni
LOCAL_INIT_RC := android.hardware.biometrics.fingerprint@2.0-service.xiaomi_santoni.rc
